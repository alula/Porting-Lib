...
public class FluidTankForge implements IFluidHandler {
	protected FluidStack fluid = FluidStack.EMPTY;
	protected long capacity;
	protected Predicate<FluidStack> validator;

	public FluidTankForge(FluidStack fluid, long capacity) {
		this(capacity);
		this.fluid = fluid;
	}

	public FluidTankForge(long capacity) {
		this(capacity, e -> true);
	}

	public FluidTankForge(long capacity, Predicate<FluidStack> validator) {
		this.capacity = capacity;
		this.validator = validator;
	}

	public FluidTankForge setValidator(Predicate<FluidStack> validator) {
		if (validator != null) {
			this.validator = validator;
		}
		return this;
	...
	public FluidTankForge readFromNBT(CompoundTag tag) {
